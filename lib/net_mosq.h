...
#ifdef WITH_TLS
// INFO:Benoit Static // void net__init_tls(void);
#endif

int net__socket_connect(struct mosquitto *mosq, const char *host, uint16_t port, const char *bind_address, bool blocking);
int net__socket_close(struct mosquitto *mosq);
// INFO:Benoit Static // int net__try_connect(const char *host, uint16_t port, mosq_sock_t *sock, const char *bind_address, bool blocking);
...
#ifdef WITH_TLS
// INFO:Benoit Static // void net__print_ssl_error(struct mosquitto *mosq);
